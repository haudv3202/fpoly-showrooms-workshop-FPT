...
btnDelete.forEach(btn => {
    btn.addEventListener('click', function () {
        ...
        Swal.fire({
            ...
            console.log(t);
            if(t.isConfirmed){
                window.location.href += `/delete/${btn.getAttribute('data-id')}`;
                Swal.fire({
                    title: "Deleted!",
                    text: "Bạn đã xóa thành công bản ghi.",
                    icon: "success",
                    confirmButtonClass: "btn btn-primary w-xs mt-2",
                    buttonsStyling: !1,
                });
