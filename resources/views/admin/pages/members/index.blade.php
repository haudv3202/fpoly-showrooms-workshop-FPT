            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Quản lí thành viên</h4>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex align-items-center ">
                                    ...
                                    <div id="dateSearch" hidden>
                                        <form action="{{ route('admin.members.search') }}" method="POST"
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <button type="button" onclick="window.location.href='{{ route('admin.members.sortDeleteRecord') }}'" class="btn ms-2 btn-warning waves-effect waves-light"
                                ...
                                @if($members->count() > 0)
                                    @foreach($members as $key => $member)
                                        <tr>
                                            ...
                                            <td>
{{--                                                <img class="img-thumbnail rounded-circle avatar-xl" alt="200x200" src="{{ \Illuminate\Support\Facades\Storage::url('images/banner/' .$member->image) }}">--}}
                                                <img class="img-thumbnail rounded-circle avatar-sm" alt="200x200" src="{{ \Illuminate\Support\Facades\Storage::url('images/member/avatar/' .$member->avatar) }}">
                                            <td>
                                                {{ $member->email }}
                                            </td>
                                            <td>
                                                {{ $member->role == 0 ? 'User' : 'Admin' }}
                                            </td>
                                            <td>{{ \Illuminate\Support\Carbon::parse($member->created_at)->format('d M, Y') }}</td>
                                            ...
                                            <td>
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a href="#!" class="dropdown-item btnPreview"
                                                               data-image="{{ \Illuminate\Support\Facades\Storage::url('images/banner/' .$member->image) }}"
                                                               data-bs-toggle="modal"
                                                               data-bs-target="#exampleModalPopovers"><i
                                                                    class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                View</a>
                                                            <!-- tooltips and popovers modal -->

                                                        <li><a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.members.edit',$member->id) }}"><i
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- Responsive Images -->
                                            <img src="" class="img-fluid w-100" style="object-fit:contain;"
                                                 id="previewImage" alt="Responsive image">
                                        </div>
                                        <div class="modal-footer">
                                            <div class="mx-auto">
                                                <a href="javascript:void(0);" class="btn btn-link fw-medium">Lỗi!!!<i
