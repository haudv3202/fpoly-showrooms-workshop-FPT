                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{ \Illuminate\Support\Facades\Storage::url('images/member/avatar/' .\Illuminate\Support\Facades\Auth::user()->avatar)  }}" alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ \Illuminate\Support\Facades\Auth::user()->name }}</span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{ \Illuminate\Support\Facades\Auth::user()->role == 0 ? 'Người dùng' : 'Quản trị viên' }}</span>
                            </span>
                        </span>
                    </button>
