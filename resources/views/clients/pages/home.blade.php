...
@section('content')
    @php
        ...
        $logo_business = $settings->filter(function($setting){
            return $setting->key == 'business_logo';
        });
        ...
        $question_case = $settings->filter(function($setting){
            return $setting->key == 'question_case';
        });
    @endphp
