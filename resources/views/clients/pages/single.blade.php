                            ...
                            >
                                <div class="client-details">
                                    ...
                                    <h6>@forelse($technicals as $key => $valueTechnical)
                                            <a href="{{ route('projects') }}?technical={{ $valueTechnical->technical->name }}" class="text-white link-redirect"> {{ $valueTechnical->technical->name }}</a>{{ $loop->last ? '' : ' / ' }}
                                        @empty
                                        @endforelse</h6>
                                </div>
                                <div class="client-details">
                                    ...
                                    <h6>     @forelse($domains as $key => $valueDomain)
                                            <a href="{{ route('projects') }}?domain={{  to_slug($valueDomain->domain->name) }}" class="text-white link-redirect">{{ $valueDomain->domain->name }}</a>{{ $loop->last ? '' : ' / ' }}
                                        @empty
                                        @endforelse</h6>
                                </div>
                                <div class="client-details">
